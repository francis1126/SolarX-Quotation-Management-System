...
const SettingsPage = () => {
  ...
  if (!settings) {
    return <div className="text-gray-500">No settings found</div>;
  }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">Manage company and quotation settings</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Quotation Settings */}
        <div className="bg-white rounded-lg shadow-sm p-4 lg:p-6 border border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Quotation Settings</h2>
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Default Validity Period (Days)</label>
                <input
                  type="number"
                  min="1"
        ...
        <div className="flex flex-col sm:flex-row justify-between gap-4">
          <button
            ...
            className="flex items-center justify-center gap-2 px-6 py-3 border border-red-300 text-red-600 rounded-lg hover:bg-red-50 transition-colors"
          >
