  ...
  const loadData = async () => {
    try {
      ...
      setFormData((prev) => ({
        ...
        termsAndConditions:
          settingsData?.quotation.defaultTermsAndConditions || "",
      }));
    } catch (error) {
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center gap-3 pt-6">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, isVatable: e.target.checked })
                    }
                    className="w-5 h-5 text-solar-600 dark:bg-gray-700 dark:border-gray-600 rounded focus:ring-solar-500"
                  />
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 lg:p-6 border border-gray-200 dark:border-gray-700">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-50">Items</h2>
          </div>
                ...
                >
                  <div className="flex justify-between items-start">
                    ...
                    <button
                      ...
                      className="ml-4 p-2 text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900 rounded-lg transition-colors"
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        readOnly
                        className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-600 text-gray-900 dark:text-gray-50"
                      />
                    </div>
                  </div>
                </div>
        ...
        {/* Summary */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 lg:p-6 border border-gray-200 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-50 mb-4">Summary</h2>
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
